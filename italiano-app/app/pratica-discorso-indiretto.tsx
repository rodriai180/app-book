...
import { CheckCircle2, Lightbulb, MessageSquare, Trophy, Volume2 } from 'lucide-react-native';
...
const ESERCIZI: Esercizio[] = [
    {
        id: 1,
        sentence: [{ text: 'Lui dice: "Vengo". -> Lui dice che ' }, { hasInput: true, text: '', text_input: '' }, { text: '.' }],
        answer: 'viene',
        translation: 'Él dice que viene.',
        hint: 'Presente -> Presente (cuando el verbo principal es presente).'
    },
    {
        id: 2,
        sentence: [{ text: 'Lui ha detto: "Vengo". -> Lui ha detto che ' }, { hasInput: true, text: '', text_input: '' }, { text: '.' }],
        answer: 'sarebbe venuto',
        translation: 'Él dijo que vendría.',
        hint: 'Presente -> Condizionale Composto (futuro nel passato).'
    },
    {
        id: 3,
        sentence: [{ text: 'Mi ha chiesto: "Come stai?" -> Mi ha chiesto come ' }, { hasInput: true, text: '', text_input: '' }, { text: '.' }],
        answer: 'stavo',
        translation: 'Me preguntó cómo estaba.',
        hint: 'Presente -> Imperfetto.'
    }
];

export default function PraticaDiscorsoIndirettoScreen() {
    ...
    if (isCompleted) {
        return (
            <View style={[styles.container, { backgroundColor: theme.surface, justifyContent: 'center', alignItems: 'center', padding: 20 }]}>
                ...
                <Text style={styles.title}>¡Reportero Estrella!</Text>
                <Text style={{ textAlign: 'center', marginVertical: 20, color: theme.muted }}>
                    Dominas el discurso indirecto. ¡Ya puedes contar todo lo que escuchas!
                </Text>
    ...
    return (
        <ScrollView style={[styles.container, { backgroundColor: theme.surface }]} contentContainerStyle={styles.contentContainer}>
            <Stack.Screen options={{ title: 'Práctica: Reporte' }} />

            <View style={[styles.progressCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
                <View style={styles.progressHeader}>
                    <MessageSquare size={16} color={theme.primary} />
                    <Text style={[styles.progressText, { color: theme.text, marginLeft: 6 }]}>Riportare le Parole</Text>
