...
import { CheckCircle2, CloudRain, Lightbulb, Trophy, Volume2 } from 'lucide-react-native';
...
const ESERCIZI: Esercizio[] = [
    {
        id: 1,
        sentence: [{ text: 'Se ' }, { hasInput: true, text: '', text_input: '' }, { text: ' (avere) tempo, verrei.' }],
        answer: 'avessi',
        translation: 'Si tuviera tiempo, vendría.',
        hint: 'Se + Congiuntivo Imperfetto (io): avessi.'
    },
    {
        id: 2,
        sentence: [{ text: 'Se lui ' }, { hasInput: true, text: '', text_input: '' }, { text: ' (essere) qui, saremmo felici.' }],
        answer: 'fosse',
        translation: 'Si él estuviera aquí, seríamos felices.',
        hint: 'Essere -> fosse.'
    },
    {
        id: 3,
        sentence: [{ text: 'Se noi ' }, { hasInput: true, text: '', text_input: '' }, { text: ' (studiare) di più, sapremmo tutto.' }],
        answer: 'studiassimo',
        translation: 'Si estudiáramos más, sabríamos todo.',
        hint: 'Studiare -> studiassimo.'
    },
    {
        id: 4,
        sentence: [{ text: 'Magari ' }, { hasInput: true, text: '', text_input: '' }, { text: ' (potere) venire!' }],
        answer: 'potessi',
        translation: '¡Ojalá pudiera venir!',
        hint: 'Deseo irreal: potessi.'
    }
];

export default function PraticaCongiuntivoImperfettoScreen() {
        ...
        return (
            <View style={[styles.container, { backgroundColor: theme.surface, justifyContent: 'center', alignItems: 'center', padding: 20 }]}>
                ...
                <View style={[styles.card, { backgroundColor: theme.card, width: '100%', alignItems: 'center', padding: 30 }]}>
                    ...
                    <Text style={[styles.title, { color: theme.text, textAlign: 'center' }]}>¡Maestro de Hipótesis!</Text>
                    <Text style={[styles.subtitle, { color: theme.muted, textAlign: 'center', marginBottom: 30 }]}>
                        Has completado la práctica del Subjuntivo Imperfecto. ¡Nada es imposible para ti!
                    </Text>
        ...
        <ScrollView style={[styles.container, { backgroundColor: theme.surface }]} contentContainerStyle={styles.contentContainer}>
            ...
            <View style={[styles.progressCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
                <View style={styles.progressHeader}>
                    <CloudRain size={16} color={theme.primary} />
                    <Text style={[styles.progressText, { color: theme.text, marginLeft: 6 }]}>Ipotesi e Desideri</Text>
