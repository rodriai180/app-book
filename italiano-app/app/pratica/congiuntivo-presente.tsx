...
import { CheckCircle2, CloudDrizzle, Lightbulb, Trophy, Volume2 } from 'lucide-react-native';
...
const ESERCIZI: Esercizio[] = [
    {
        id: 1,
        sentence: [{ text: 'Credo che lui ' }, { hasInput: true, text: '', text_input: '' }, { text: ' (essere) stanco.' }],
        answer: 'sia',
        translation: 'Creo que él está cansado.',
        hint: 'Congiuntivo de ESSERE (lui): sia.'
    },
    {
        id: 2,
        sentence: [{ text: 'Penso che tu ' }, { hasInput: true, text: '', text_input: '' }, { text: ' (avere) ragione.' }],
        answer: 'abbia',
        translation: 'Pienso que tienes razón.',
        hint: 'Congiuntivo de AVERE (tu): abbia.'
    },
    {
        id: 3,
        sentence: [{ text: 'Dubito che loro ' }, { hasInput: true, text: '', text_input: '' }, { text: ' (venire) oggi.' }],
        answer: 'vengano',
        translation: 'Dudo que vengan hoy.',
        hint: 'Venire -> vengano (loro).'
    },
    {
        id: 4,
        sentence: [{ text: 'Spero che todo ' }, { hasInput: true, text: '', text_input: '' }, { text: ' (andare) bene.' }],
        answer: 'vada',
        translation: 'Espero que todo vaya bien.',
        hint: 'Andare -> vada (lui).'
    },
    {
        id: 5,
        sentence: [{ text: 'Voglio che tu ' }, { hasInput: true, text: '', text_input: '' }, { text: ' (fare) i compiti.' }],
        answer: 'faccia',
        translation: 'Quiero que hagas los deberes.',
        hint: 'Fare -> faccia (tu).'
    }
];

export default function PraticaCongiuntivoPresenteScreen() {
        ...
        return (
            <View style={[styles.container, { backgroundColor: theme.surface, justifyContent: 'center', alignItems: 'center', padding: 20 }]}>
                ...
                <View style={[styles.card, { backgroundColor: theme.card, width: '100%', alignItems: 'center', padding: 30 }]}>
                    ...
                    <Text style={[styles.title, { color: theme.text, textAlign: 'center' }]}>¡Dominador del Opinión!</Text>
                    <Text style={[styles.subtitle, { color: theme.muted, textAlign: 'center', marginBottom: 30 }]}>
                        Has completado la práctica del Subjuntivo Presente. ¡Tu nivel de debate está subiendo!
                    </Text>
    ...
    return (
        <ScrollView style={[styles.container, { backgroundColor: theme.surface }]} contentContainerStyle={styles.contentContainer}>
            <Stack.Screen options={{ title: 'Práctica: Congiuntivo' }} />

            <View style={[styles.progressCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
                <View style={styles.progressHeader}>
                    <CloudDrizzle size={16} color={theme.primary} />
                    <Text style={[styles.progressText, { color: theme.text, marginLeft: 6 }]}>Opinioni e Dubbi</Text>
