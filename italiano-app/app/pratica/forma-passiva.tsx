...
import { CheckCircle2, Lightbulb, RefreshCcw, Trophy, Volume2 } from 'lucide-react-native';
...
const ESERCIZI: Esercizio[] = [
    {
        id: 1,
        sentence: [{ text: 'La mela ' }, { hasInput: true, text: '', text_input: '' }, { text: ' (essere) mangiata da Marco.' }],
        answer: 'è',
        translation: 'La manzana es comida por Marco.',
        hint: 'Presente Passivo: Essere + Participio.'
    },
    {
        id: 2,
        sentence: [{ text: 'Il libro ' }, { hasInput: true, text: '', text_input: '' }, { text: ' (venire) letto da muchos.' }],
        answer: 'viene',
        translation: 'El libro es leído por muchos.',
        hint: 'Passivo con VENIRE (enfatiza la acción).'
    },
    {
        id: 3,
        sentence: [{ text: 'Le chiavi ' }, { hasInput: true, text: '', text_input: '' }, { text: ' (essere) state trovate.' }],
        answer: 'sono',
        translation: 'Las llaves han sido encontradas.',
        hint: 'Passato Prossimo Passivo: Sono state.'
    }
];

export default function PraticaFormaPassivaScreen() {
    ...
    if (isCompleted) {
        return (
            <View style={[styles.container, { backgroundColor: theme.surface, justifyContent: 'center', alignItems: 'center', padding: 20 }]}>
                ...
                <Text style={styles.title}>¡Enfoque Total!</Text>
                <Text style={{ textAlign: 'center', marginVertical: 20, color: theme.muted }}>
                    Dominas la voz pasiva. ¡Ya puedes cambiar el enfoque de cualquier historia!
                </Text>
    ...
    return (
        <ScrollView style={[styles.container, { backgroundColor: theme.surface }]} contentContainerStyle={styles.contentContainer}>
            <Stack.Screen options={{ title: 'Práctica: Passiva' }} />

            <View style={[styles.progressCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
                <View style={styles.progressHeader}>
                    <RefreshCcw size={16} color={theme.primary} />
                    <Text style={[styles.progressText, { color: theme.text, marginLeft: 6 }]}>Cambiare il Punto di Vista</Text>
