...
const ESERCIZI: Esercizio[] = [
    {
        id: 1,
        sentence: [{ text: 'Io ' }, { hasInput: true, text: '', text_input: '' }, { text: ' (andare) al mare, ma pioveva.' }],
        answer: 'sarei andato',
        translation: 'Habría ido al mar, pero llovía.',
        hint: 'Condizionale Composto: Sarei + andato.'
    },
    {
        id: 2,
        sentence: [{ text: 'Lui ' }, { hasInput: true, text: '', text_input: '' }, { text: ' (potere) aiutarmi.' }],
        answer: 'avrebbe potuto',
        translation: 'Él habría podido ayudarme.',
        hint: 'Avere -> avrebbe + potuto.'
    },
    {
        id: 3,
        sentence: [{ text: 'Noi ' }, { hasInput: true, text: '', text_input: '' }, { text: ' (venire) ieri.' }],
        answer: 'saremmo venuti',
        translation: 'Habríamos venido ayer.',
        hint: 'Essere -> saremmo + venuti.'
    },
    {
        id: 4,
        sentence: [{ text: 'Voi ' }, { hasInput: true, text: '', text_input: '' }, { text: ' (dovere) dirmelo.' }],
        answer: 'avreste dovuto',
        translation: 'Deberíais habérmelo dicho.',
        hint: 'Avere -> avreste + dovuto.'
    }
];

export default function PraticaCondizionaleCompostoScreen() {
        ...
        return (
            <View style={[styles.container, { backgroundColor: theme.surface, justifyContent: 'center', alignItems: 'center', padding: 20 }]}>
                ...
                <View style={[styles.card, { backgroundColor: theme.card, width: '100%', alignItems: 'center', padding: 30 }]}>
                    ...
                    <Text style={[styles.title, { color: theme.text, textAlign: 'center' }]}>¡Experto en Hipótesis!</Text>
                    <Text style={[styles.subtitle, { color: theme.muted, textAlign: 'center', marginBottom: 30 }]}>
                        Has completado la práctica del Condicional Compuesto. ¡Imparable!
                    </Text>
        ...
        <ScrollView style={[styles.container, { backgroundColor: theme.surface }]} contentContainerStyle={styles.contentContainer}>
            ...
            <View style={[styles.progressCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
                <View style={styles.progressHeader}>
                    ...
                    <Text style={[styles.progressText, { color: theme.text, marginLeft: 6 }]}>Passato e Rimorsi</Text>
...
const styles = StyleSheet.create({
    /* Consistency with previous screens */
    container: { flex: 1 },
